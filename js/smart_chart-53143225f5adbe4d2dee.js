...
var Chart = function (_React$Component) {
    ...
    _createClass(Chart, [{
        ...
        value: function render() {
            ...
            var duration = this.props.end_epoch - this.props.start_epoch;

            var margin = granularity === 0 ? Math.max(300, 30 * duration / (60 * 60) || 0) : 3 * granularity;

            // load more ticks so we can draw one tick before and one tick after contract
            var start_margin = (this.props.start_epoch - margin).toFixed(0);
            var end_margin = (this.props.end_epoch + margin).toFixed(0);
